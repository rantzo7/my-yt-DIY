...
export default function appHandler (req, res) {
  ...
  if (url.pathname === '/components/forms/upload-cookies-form.js') { return fileHandler('client/components/forms/upload-cookies-form.js', 'application/javascript')(req, res) }
